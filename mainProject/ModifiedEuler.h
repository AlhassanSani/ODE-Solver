...
namespace mainProject {
	...
	/// <summary>
	/// Summary for ModifiedEuler
	/// </summary>
	public ref class ModifiedEuler : public System::Windows::Forms::Form
	{
	public:
		ModifiedEuler(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(ModifiedEuler::typeid));
			...
			this->listView1->Location = System::Drawing::Point(58, 112);
			...
			this->textBox1->Size = System::Drawing::Size(69, 25);
			...
			this->label1->Location = System::Drawing::Point(20, 64);
			...
			this->textBox2->Location = System::Drawing::Point(185, 60);
			this->textBox2->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(69, 25);
			...
			this->label2->Location = System::Drawing::Point(147, 64);
			...
			this->label3->Location = System::Drawing::Point(275, 64);
			...
			this->textBox4->Location = System::Drawing::Point(510, 61);
			this->textBox4->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->textBox4->Name = L"textBox4";
			this->textBox4->Size = System::Drawing::Size(69, 25);
			...
			this->label4->Location = System::Drawing::Point(433, 65);
			...
			this->button1->Location = System::Drawing::Point(690, 542);
			...
			this->button1->Click += gcnew System::EventHandler(this, &ModifiedEuler::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Location = System::Drawing::Point(807, 542);
			...
			this->numericUpDown1->Location = System::Drawing::Point(720, 65);
			this->numericUpDown1->Margin = System::Windows::Forms::Padding(3, 4, 3, 4);
			this->numericUpDown1->Name = L"numericUpDown1";
			this->numericUpDown1->Size = System::Drawing::Size(101, 25);
			...
			this->label5->Location = System::Drawing::Point(616, 67);
			...
			this->Name = L"ModifiedEuler";
			this->Text = L"Modified Euler Method";
